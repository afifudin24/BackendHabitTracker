...
const getMe = async (req, res) => {
  try {
    ...
    console.error(error);
    return res.status(500).json({ message: 'Terjadi kesalahan saat mendapatkan data pengguna' });
  }
}
const createUser = async (req, res) => {
  try {
    ...
    console.error(error);
    return res.status(500).json({ message: 'Terjadi kesalahan saat membuat pengguna' });
  }
};
...
const updateUser = async (req, res) => {
  try {
    ...
    console.error(error);
    return res.status(500).json({ message: 'Terjadi kesalahan saat mengupdate data pengguna' });
  }
};
